////////////////////////////////////////////////////////////////////////
// $Id: virt_timer.cc 12615 2015-01-25 21:24:13Z sshwarts $
/////////////////////////////////////////////////////////////////////////
//
...
#ifdef BX_ANDROID
bx_virt_timer_c *bx_virt_timer_c::theInstance;
void bx_virt_timer_c::handleSuspend()
{
	sleepTime= time(NULL);
}
void bx_virt_timer_c::handleResume()
{
	if (sleepTime==0)
		return;
	Bit64u diff= time(NULL)-sleepTime;
	total_real_usec += diff*1000000;
#if BX_HAVE_REALTIME_USEC
	last_real_time = GET_VIRT_REALTIME64_USEC();
#endif
    sleepTime= 0;
