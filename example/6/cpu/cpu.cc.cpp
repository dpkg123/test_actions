...
bxICache_c BX_CPU_C::iCache BX_CPP_AlignN(32);
#endif
jmp_buf BX_CPU_C::jmp_buf_env;
bool BX_CPU_C::jumped = false;
#if BX_SUPPORT_MONITOR_MWAIT
unsigned int monitor_addr_t::numMonitorArmed = 0;
#endif
#if BX_USE_CPU_SMF
BX_CPU_C *BX_CPU_C::theCpu;
BX_CPU_C *BX_CPU_C::theCpuSaved;
#endif
...
{
  static int maxInstr = BX_MAX_TRACE_LENGTH * BX_MAX_TRACE_LENGTH;
  ...
  if(delta >= bx_pc_system.getNumCpuTicksLeftNextEvent() || delta >= maxInstr) {
    return;
  }
