...
/**
 * GENERATED Data contract class EditTagEvent.
 *
 * "User action EditTag event"
 */
public class EditTagEvent extends ActionEvent
{
    private String name = "EditTag";
    
    /**
     * Creates a new instance of the EditTagEvent class.
     *
