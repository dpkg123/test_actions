...
/**
 * GENERATED Data contract class UpdateAlbumCoverEvent.
 *
 * "User action UpdateAlbumCover event"
 */
public class UpdateAlbumCoverEvent extends ActionEvent
{
    private String name = "UpdateAlbumCover";
    
    /**
     * Creates a new instance of the UpdateAlbumCoverEvent class.
     *
