...
/**
 * GENERATED Data contract class RestoreEvent.
 *
 * "User action Restore event"
 */
public class RestoreEvent extends ActionEvent
{
    private String name = "Restore";
    
    /**
     * Creates a new instance of the RestoreEvent class.
     *
