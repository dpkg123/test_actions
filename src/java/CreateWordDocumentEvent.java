...
/**
 * GENERATED Data contract class CreateWordDocumentEvent.
 *
 * "User action CreateWordDocument event"
 */
public class CreateWordDocumentEvent extends ActionEvent
{
    private String name = "CreateWordDocument";
    
    /**
     * Creates a new instance of the CreateWordDocumentEvent class.
     *
     ...
     */
    public CreateWordDocumentEvent(
