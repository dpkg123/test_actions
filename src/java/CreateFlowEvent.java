...
/**
 * GENERATED Data contract class CreateFlowEvent.
 *
 * "User action CreateFlow event"
 */
public class CreateFlowEvent extends ActionEvent
{
    private String name = "CreateFlow";
    
    /**
     * Creates a new instance of the CreateFlowEvent class.
     *
