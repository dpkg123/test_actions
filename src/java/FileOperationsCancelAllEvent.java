...
/**
 * GENERATED Data contract class FileOperationsCancelAllEvent.
 *
 * "User action Cancel all file operations event"
 */
public class FileOperationsCancelAllEvent extends ActionEvent
{
    private String name = "FileOperationsCancelAll";
    
    /**
     * Creates a new instance of the FileOperationsCancelAllEvent class.
     *
     ...
     */
    public FileOperationsCancelAllEvent(
