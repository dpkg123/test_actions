...
/**
 * GENERATED Data contract class ShareToOneDriveAppEvent.
 *
 * "User action Share-to-OneDrive event"
 */
public class ShareToOneDriveAppEvent extends ActionEvent
{
    private String name = "ShareToOneDriveApp";
    
    /**
     * Creates a new instance of the ShareToOneDriveAppEvent class.
     *
     ...
     */
    public ShareToOneDriveAppEvent(
