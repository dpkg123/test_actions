...
/**
 * GENERATED Data contract class UploadFileEvent.
 *
 * "User action UploadFile event"
 */
public class UploadFileEvent extends ActionEvent
{
    private String name = "UploadFile";
    
    /**
     * Creates a new instance of the UploadFileEvent class.
     *
