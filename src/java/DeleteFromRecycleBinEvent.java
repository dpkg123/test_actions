...
/**
 * GENERATED Data contract class DeleteFromRecycleBinEvent.
 *
 * "User action DeleteFromRecycleBin event"
 */
public class DeleteFromRecycleBinEvent extends ActionEvent
{
    private String name = "DeleteFromRecycleBin";
    
    /**
     * Creates a new instance of the DeleteFromRecycleBinEvent class.
     *
     ...
     */
    public DeleteFromRecycleBinEvent(
