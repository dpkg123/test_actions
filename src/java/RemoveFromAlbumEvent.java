...
/**
 * GENERATED Data contract class RemoveFromAlbumEvent.
 *
 * "User action RemoveFromAlbum event"
 */
public class RemoveFromAlbumEvent extends ActionEvent
{
    private String name = "RemoveFromAlbum";
    
    /**
     * Creates a new instance of the RemoveFromAlbumEvent class.
     *
