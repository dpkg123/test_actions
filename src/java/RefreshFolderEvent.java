...
/**
 * GENERATED Data contract class RefreshFolderEvent.
 *
 * "User action RefreshFolder event"
 */
public class RefreshFolderEvent extends ActionEvent
{
    private String name = "RefreshFolder";
    
    /**
     * Creates a new instance of the RefreshFolderEvent class.
     *
