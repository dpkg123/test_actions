...
/**
 * GENERATED Data contract class ODBManualUploadResultEvent.
 *
 * "An event that represents ODB manual upload event."
 */
public class ODBManualUploadResultEvent extends ManualUploadResultEvent
{
    private String name = "ODBManualUploadResult";
    
    /**
     * Creates a new instance of the ODBManualUploadResultEvent class.
     *
     ...
     */
    public ODBManualUploadResultEvent(
