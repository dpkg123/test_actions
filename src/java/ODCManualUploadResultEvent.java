...
/**
 * GENERATED Data contract class ODCManualUploadResultEvent.
 *
 * "An event that represents ODC manual upload event."
 */
public class ODCManualUploadResultEvent extends ManualUploadResultEvent
{
    private String name = "ODCManualUploadResult";
    
    /**
     * Creates a new instance of the ODCManualUploadResultEvent class.
     *
     ...
     */
    public ODCManualUploadResultEvent(
            ...
            BuildType buildType) {
        super(sharingLevel, timeToUpload, extension, localIdentifier, uploadInBackground, itemType, itemUploadState, chunkStage, completionStatus, account, privacyDataType, privacyTag, buildType);
    }
