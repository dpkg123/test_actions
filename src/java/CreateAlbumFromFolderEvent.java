...
/**
 * GENERATED Data contract class CreateAlbumFromFolderEvent.
 *
 * "User action CreateAlbumFromFolder event"
 */
public class CreateAlbumFromFolderEvent extends ActionEvent
{
    private String name = "CreateAlbumFromFolder";
    
    /**
     * Creates a new instance of the CreateAlbumFromFolderEvent class.
     *
     ...
     */
    public CreateAlbumFromFolderEvent(
