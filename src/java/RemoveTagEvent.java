...
/**
 * GENERATED Data contract class RemoveTagEvent.
 *
 * "User action RemoveTag event"
 */
public class RemoveTagEvent extends ActionEvent
{
    private String name = "RemoveTag";
    
    /**
     * Creates a new instance of the RemoveTagEvent class.
     *
