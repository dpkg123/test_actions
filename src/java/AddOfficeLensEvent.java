...
/**
 * GENERATED Data contract class AddOfficeLensEvent.
 *
 * "User action AddOfficeLens event"
 */
public class AddOfficeLensEvent extends ActionEvent
{
    private String name = "AddOfficeLens";
    
    /**
     * Creates a new instance of the AddOfficeLensEvent class.
     *
