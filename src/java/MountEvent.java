...
/**
 * GENERATED Data contract class MountEvent.
 *
 * "User action Mount event"
 */
public class MountEvent extends ActionEvent
{
    private String name = "Mount";
    
    /**
     * Creates a new instance of the MountEvent class.
     *
