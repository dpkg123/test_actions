...
/**
 * GENERATED Data contract class CreateFolderEvent.
 *
 * "User action CreateFolder event"
 */
public class CreateFolderEvent extends ActionEvent
{
    private String name = "CreateFolder";
    
    /**
     * Creates a new instance of the CreateFolderEvent class.
     *
