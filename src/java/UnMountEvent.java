...
/**
 * GENERATED Data contract class UnMountEvent.
 *
 * "User action UnMount event"
 */
public class UnMountEvent extends ActionEvent
{
    private String name = "UnMount";
    
    /**
     * Creates a new instance of the UnMountEvent class.
     *
