...
/**
 * GENERATED Data contract class AddToAlbumEvent.
 *
 * "User action AddToAlbum event"
 */
public class AddToAlbumEvent extends ActionEvent
{
    private String name = "AddToAlbum";
    
    /**
     * Creates a new instance of the AddToAlbumEvent class.
     *
