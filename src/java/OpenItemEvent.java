...
/**
 * GENERATED Data contract class OpenItemEvent.
 *
 * "User action OpenItem event"
 */
public class OpenItemEvent extends ActionEvent
{
    private String name = "OpenItem";
    
    /**
     * Creates a new instance of the OpenItemEvent class.
     *
