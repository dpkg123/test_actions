...
/**
 * GENERATED Data contract class CreateAlbumWithSelectionEvent.
 *
 * "User action CreateAlbumWithSelection event"
 */
public class CreateAlbumWithSelectionEvent extends ActionEvent
{
    private String name = "CreateAlbumWithSelection";
    
    /**
     * Creates a new instance of the CreateAlbumWithSelectionEvent class.
     *
     ...
     */
    public CreateAlbumWithSelectionEvent(
