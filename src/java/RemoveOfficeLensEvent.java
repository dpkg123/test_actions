...
/**
 * GENERATED Data contract class RemoveOfficeLensEvent.
 *
 * "User action RemoveOfficeLens event"
 */
public class RemoveOfficeLensEvent extends ActionEvent
{
    private String name = "RemoveOfficeLens";
    
    /**
     * Creates a new instance of the RemoveOfficeLensEvent class.
     *
