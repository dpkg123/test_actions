...
/**
 * GENERATED Data contract class CreateExcelSpreadsheetEvent.
 *
 * "User action CreateExcelSpreadsheet event"
 */
public class CreateExcelSpreadsheetEvent extends ActionEvent
{
    private String name = "CreateExcelSpreadsheet";
    
    /**
     * Creates a new instance of the CreateExcelSpreadsheetEvent class.
     *
     ...
     */
    public CreateExcelSpreadsheetEvent(
