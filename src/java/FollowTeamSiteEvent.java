...
/**
 * GENERATED Data contract class FollowTeamSiteEvent.
 *
 * "User action to follow a team site"
 */
public class FollowTeamSiteEvent extends ActionEvent
{
    private String name = "FollowTeamSite";
    
    private Boolean following;
    
    /**
     * Creates a new instance of the FollowTeamSiteEvent class.
     *
     ...
     * @param following    True if the site is now being followed, false is un-following
     */
    public FollowTeamSiteEvent(
            Boolean following,
    ...
    /**
     * Sets the Following property. "True if the site is now being followed, false is un-following"
     */
    ...
    public Map<String, String> getProperties() {
        ...
        if (following != null) {
            map.put("Following", String.valueOf(this.following));
        }
