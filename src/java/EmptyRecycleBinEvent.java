...
/**
 * GENERATED Data contract class EmptyRecycleBinEvent.
 *
 * "User action EmptyRecycleBin event"
 */
public class EmptyRecycleBinEvent extends ActionEvent
{
    private String name = "EmptyRecycleBin";
    
    /**
     * Creates a new instance of the EmptyRecycleBinEvent class.
     *
