...
/**
 * GENERATED Data contract class SortEvent.
 *
 * "User action Sort"
 */
public class SortEvent extends ActionEvent
{
    ...
    private SortOrderType fromSortOrder;
    
    /**
     * Creates a new instance of the SortEvent class.
     *
     ...
     * @param fromSortOrder    Former sort order
     */
    public SortEvent(
            SortOrderType fromSortOrder,
        ...
        this.fromSortOrder = fromSortOrder;
    }
    ...
    /**
     * Sets the SortOrder property. "New sort order"
     */
    ...
    /**
     * Gets the FromSortOrder property.
     */
    public SortOrderType getFromSortOrder() {
        return this.fromSortOrder;
    }
    
    /**
     * Sets the FromSortOrder property. "Former sort order"
     */
    public void setFromSortOrder(SortOrderType value) {
        this.fromSortOrder = value;
    }
    ...
    public Map<String, String> getProperties() {
        ...
        if (fromSortOrder != null) {
            map.put("FromSortOrder", fromSortOrder.name());
        }
    ...
    public Set<String> getEmptyProperties() {
        ...
        if (sortOrder == null) {
            blankProperties.add("sortOrder");
        }
        if (fromSortOrder == null) {
            blankProperties.add("fromSortOrder");
        }
