...
/**
 * GENERATED Data contract class CreatePowerpointPresentationEvent.
 *
 * "User action CreatePowerpointPresentation event"
 */
public class CreatePowerpointPresentationEvent extends ActionEvent
{
    private String name = "CreatePowerpointPresentation";
    
    /**
     * Creates a new instance of the CreatePowerpointPresentationEvent class.
     *
     ...
     */
    public CreatePowerpointPresentationEvent(
